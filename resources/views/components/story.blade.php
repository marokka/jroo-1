                    ...
                    <div class="col-12">
                        <div class="featured-use text-md-right">
                            ...
                            <div class="featured-use_icon text-md-right order-1 order-md-2 featured-use_icon-left">
                                <div class="icon-detail"><img src="{{asset('frontend/images/imput1.png')}}" alt=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="featured-use text-md-right">
                            ...
                            <div class="featured-use_icon text-md-right order-1 order-md-2 featured-use_icon-left">
                                <div class="icon-detail"><img src="{{asset('frontend/images/imput2.png')}}" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="featured-use">
                            ...
                            <div class="featured-use_icon order-1 ml-0">
                                <div class="icon-detail"><img src="{{asset('frontend/images/imput3.png')}}" alt=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="featured-use">
                            ...
                            <div class="featured-use_icon order-1 ml-0">
                                <div class="icon-detail"><img src="{{asset('frontend/images/imput4.png')}}" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
